...
\begin{minipage}{\textwidth}
    ...
    \captionof{figure}{This feed-forward network model allows complete control
        over how many useful and noisy dimensions there are, the relative
        reliability of each source, and how complex the decision boundary
        between classes is.}
...
Forest. Although these aspects negatively affect the accuracy of GMKL as well, we saw that GMKL was much more resistant to these factor than the standard classifiers. Not only does this illustrate the usefulness of GMKL as a tool for
