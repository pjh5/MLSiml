...
theoretically be 100\%, providing a consistent benchmark across all
experiments.
...
this may seem like a small number of dimensions, but recall that the XOR has a very
...
\begin{minipage}{\textwidth}
\centering
\subsubsection*{Experiment 3: Noise Dimensions}
\begin{tabular}{|c| c| c| c| c| c| c|}
\hline
