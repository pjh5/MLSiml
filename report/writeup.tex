...
\begin{minipage}{\textwidth}
    \begin{minipage}{.5\textwidth}
        ...
        \captionof{figure}{An illustration of the ability of GMKL to ignore
            useless data sources.}
        \label{fig:dxor_heat_gmkl}
    \end{minipage}
    \begin{minipage}{.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{dxor_heat_conc.png}
        \captionof{figure}{An illustration that demonstrates Concatenate + GMKL
            is vulnerable to unimportant sources.}
...
\begin{minipage}{\textwidth}
    ...
    \captionof{figure}{An illustration that shows GMKL is unable to classify
        accurately using a Sine Wave source.}
