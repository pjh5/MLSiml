...
\begin{minipage}{\textwidth}
    ...
    \captionof{figure}{This feed-forward network model allows complete control over how many useful and noisy dimensions there are, the relative reliability of each source, and how complex the decision boundary between classes is.}
...
\captionof{figure}{An illustration of how resistant GMKL is to the affect of an increasingly complex XOR decision boundary compared to the standard classifiers.}
\label{fig:exp_1}
\end{minipage}
...
\begin{minipage}{\textwidth}
    \begin{minipage}{.5\textwidth}
        ...
        \captionof{figure}{An illustration of the ability of GMKL to ignore useless data sources.}
        \label{fig:dxor_heat_gmkl}
    \end{minipage}
    \begin{minipage}{.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{dxor_heat_conc.png}
        \captionof{figure}{An illustration that demonstrates Concatenate + GMKL is vulnerable to unimportant sources.}
...
\begin{minipage}{\textwidth}
    ...
    \captionof{figure}{An illustration that shows GMKL is unable to classify accurately using a Sine Wave source.}
